from code.download_dataset import aquire_training_data
...
def main():
    ...
    with mlflow.start_run():
        ...
        mlflow.log_metric(
            "precision_label", precision_score(y_test, predicted, average="weighted")
        )
        mlflow.log_metric(
            "f1_score_label", f1_score(y_test, predicted, average="weighted")
        )
        mlflow.log_metric(
            "recall_label", recall_score(y_test, predicted, average="weighted")
        )
